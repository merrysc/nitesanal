...
repNo = list(range(1,31))
#fstFrame = list(range(5,117))

#FrameStim=[23,29,35,41,47,53] 
...
angleSeq = [40]
#so far  done (for 2s only) 0,10,50,20,80,30,60,70
...
#            soundTLoc =1
        ...
        for nFrames in range(stGap-fstFrame-stimLength):
            fixation1.draw()
